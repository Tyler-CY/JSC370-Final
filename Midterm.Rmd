...
# API changed the dataset column names, thus rendering the code useless. Used the old downloaded dataset copy.
...
```{r unused-crime-map, echo = F, eval = F}
coordinates <- rgdal::readOGR('./data/Neighbourhoods - historical 140 - 4326.geojson')
